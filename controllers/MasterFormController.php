...
use app\services\RelationPickerService;
...
class MasterFormController extends Controller
{
    ...
    private RelationPickerService $relationPickerService;
    ...
    public function init()
    {
        ...
        $this->relationPickerService = new RelationPickerService();
    }
    ...
    public function actionRelationPickerData($form_id = null, $field_name = null)
    {
        ...
        try {
            ...
            $pageSize = min(50, max(1, (int)Yii::$app->request->get('page_size', 10)));

            return $this->relationPickerService->getPickerData($formId, $fieldName, $keyword, $page, $pageSize);
        } catch (\Throwable $e) {
            Yii::error([
    ...
    public function actionRelationPickerSearch($form_id = null, $field_name = null)
    {
        ...
        try {
            ...
            return $this->relationPickerService->search($formId, $fieldName, $keyword, $limit);
        } catch (\Throwable $e) {
            Yii::error([
    ...
    public function actionResolveAutofill($form_id = null, $trigger_field = null, $trigger_value = null)
    {
        ...
        try {
            ...
            return $this->relationPickerService->resolveAutofill($formId, $triggerField, $triggerValue);
        } catch (\Throwable $e) {
            Yii::error([
