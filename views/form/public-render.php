    ...
    <div class="max-w-2xl mx-auto px-4 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div id="formContent" class="p-8 hidden">
                ...
                <?php else: ?>
                    <form method="post" action="<?= \yii\helpers\Url::to(['form/submit', 'id' => $model->id]) ?>" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <?php foreach ($schema as $field): ?>
                            ...
                            <?php elseif ($fieldType === 'submit'): ?>
                                <!-- Submit button will be rendered after the form fields -->
                        ...
                        <!-- Submit Button -->
                        <div class="pt-6">
                            <button type="submit" id="submitBtn" class="w-full bg-gradient-to-r from-primary to-primary-dark text-white font-semibold py-4 px-6 rounded-xl hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200">
                                Kirim Form
                            </button>
                        </div>
                    </form>
