    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm mb-4">
            ...
            <form id="master-form-form" method="post">
                ...
                <div style="display:flex;gap:12px;padding:12px 20px;align-items:center;">
                    <input type="text" name="MasterForm[form_name]" class="prop-input" placeholder="Nama Form" style="flex:1;max-width:400px;">
                </div>
            </form>
            </form>
        </div>
