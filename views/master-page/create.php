...
$this->title = 'Tambah Halaman Dinamis';
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">Tambah Halaman</h1>
                        <p class="text-sm text-gray-500">Siapkan halaman dinamis lalu hubungkan ke sidebar.</p>
                    </div>
                </div>
